...
export const LazyStrukturOrganisasiPage = withLazyLoading(
  () => import('./StrukturOrganisasiPage'),
  LoadingSpinner
)

export const LazyGrandDesignPage = withLazyLoading(
  () => import('./GrandDesignPage'),
  LoadingSpinner
)
...
export const preloadCriticalPages = () => {
  ...
  const criticalPages = [
    { name: 'blog', importFunc: () => import('./BlogPage'), priority: 'high' },
    { name: 'events', importFunc: () => import('./EventsPage'), priority: 'high' },
    { name: 'kontak', importFunc: () => import('./KontakPage'), priority: 'medium' },
    { name: 'galeri', importFunc: () => import('./GaleriPage'), priority: 'medium' },
    { name: 'grand-design', importFunc: () => import('./GrandDesignPage'), priority: 'low' }
  ]
...
export const preloadPage = (pageName: string, currentPage?: string) => {
  ...
  const pageImports: Record<string, () => Promise<any>> = {
    ...
    'visi-misi': () => import('./VisiMisiPage'),
    'struktur-organisasi': () => import('./StrukturOrganisasiPage'),
