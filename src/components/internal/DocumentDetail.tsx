        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-100 dark:border-[#1F1F1F]">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-2 mt-2 text-xs">
              <span className="font-mono px-2 py-1 rounded bg-slate-100 dark:bg-[#1E1E1E] text-slate-600 dark:text-slate-300">
                {document.ticket_number}
              </span>
              <span className={`px-2 py-1 rounded-full font-semibold ${statusColors[document.status]}`}>
